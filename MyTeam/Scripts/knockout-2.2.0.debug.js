...
(function () {
    ...
    function simpleHtmlParse(html) {
        ...
        var wrap = tags.match(/^<(thead|tbody|tfoot)/)              && [1, "<table class="table">", "</table>"] ||
                   !tags.indexOf("<tr")                             && [2, "<table class="table"><tbody>", "</tbody></table>"] ||
                   (!tags.indexOf("<td") || !tags.indexOf("<th"))   && [3, "<table class="table"><tbody><tr>", "</tr></tbody></table>"] ||
                   /* anything else */                                 [0, "", ""];
